...
_ALIASES: Dict[str, List[str]] = {
    ...
    # ── Trade / Policy synonyms (critical for multilingual translations) ──
    "taxes":              ["tariffs", "us tariffs", "trump tariffs"],
    "tax":                ["tariffs", "us tariffs"],
    "duty":               ["tariffs", "us tariffs", "tariff hike"],
    "duties":             ["tariffs", "us tariffs", "tariff hike"],
    "import duty":        ["tariffs", "tariff hike"],
    "us taxes":           ["us tariffs", "tariffs"],
    "american taxes":     ["us tariffs", "tariffs"],
    "american tariffs":   ["us tariffs", "tariffs"],
    "trump tax":          ["trump tariffs", "us tariffs"],
    "trade war":          ["us tariffs", "tariffs", "trump tariffs"],
    "trade tension":      ["us tariffs", "tariffs"],
    "tariff war":         ["us tariffs", "tariffs", "trump tariffs"],
    "reciprocal tariff":  ["reciprocal tariff rate", "us tariffs"],
    # ── Market synonyms ───────────────────────────────────────────────────
    "indian markets":     ["stock market", "indian stock market", "india inc"],
    "indian market":      ["stock market", "indian stock market", "india inc"],
    "stock markets":      ["stock market"],
    "equity market":      ["stock market"],
    "equity markets":     ["stock market"],
    "share market":       ["stock market"],
    "indian economy":     ["india inc", "gdp", "gross domestic product"],
    "india market":       ["stock market", "india inc"],
    "market":             ["stock market", "market"],
    "markets":            ["stock market", "market"],
    # ── Rate / monetary synonyms ──────────────────────────────────────────
    "rate cut":           ["repo rate cut", "rate cut"],
    "repo rate":          ["repo rate", "rate cut"],
    "interest rate":      ["repo rate", "rate cut", "interest rates"],
    "interest rates":     ["interest rates", "repo rate"],
    "monetary policy":    ["monetary policy", "rbi", "reserve bank of india"],
    # ── Commodity synonyms ────────────────────────────────────────────────
    "oil":                ["crude oil", "west texas intermediate", "brent crude"],
    "petroleum":          ["crude oil"],
    "gold":               ["gold prices", "gold"],
    "silver":             ["silver"],
    # ── Sector synonyms ───────────────────────────────────────────────────
    "pharma":             ["pharmaceutical", "sun pharmaceutical", "cipla"],
    "pharmaceuticals":    ["pharmaceutical", "sun pharmaceutical"],
    "it sector":          ["it services", "infosys", "wipro"],
    "technology":         ["it services", "infosys", "wipro"],
    "banking":            ["bank", "hdfc bank", "icici bank", "state bank of india"],
    "banks":              ["bank", "hdfc bank", "icici bank"],
    "automobile":         ["auto", "tata motors", "maruti suzuki india"],
    "auto sector":        ["auto", "tata motors", "maruti suzuki india"],
}
